...
<head>
	...
	<title>OASA Approved request</title>
...
<div class="fixed-navbar">
	<div class="pull-left">
		...
		<h1 class="page-title">Approved Requst</h1>
		<!-- /.page-title -->
	</div>
	<!-- /.pull-left -->
		...
		<div class="row justify-content-center">
			<div class="col-xs-12 col-sm-10  col-md-10  col-lg-10 col-xl-10">
				...
				<div class="box-content card white ">
                    ...
                    $db= mysqli_connect("localhost", $user, $pass, $dbname);
                    if($db){
                        $query=mysqli_query($db, "select * from approved_purchase_request");
                        if($query){
