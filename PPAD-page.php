...
<div id="wrapper">
	<div class="main-content">
		<div class="row ">
			...
			<div class="col-lg-4 col-xs-12">
				<div class="box-content">
					<h4 class="box-title text-info">Request Recived</h4>
					<div class="content widget-stat">
						<div class="left-content margin-top-15">
							<i class="menu-icon fa fa-download"></i>
						</div>
						...
						<div class="right-content">
							...
							<a href="Recived Request.php" >More <i class="fa fa-arrow-circle-right"></i></a>
						</div>
					</div>	
				</div>
			</div>
			...
			<div class="col-lg-4 col-xs-12">
				<div class="box-content">
					<h4 class="box-title text-info">Approved requests</h4>
					<div class="content widget-stat">
						...
						<div class="right-content">	
							...
							<a href="Approve request.php" >More <i class="fa fa-arrow-circle-right"></i></a>
						</div>
					</div>
				</div>	
			</div>
