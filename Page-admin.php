...
<div id="wrapper">
	<div class="main-content">
		<div class="row ">
				...
				<div class="box-content">
					...
					<div class="content widget-stat">
						...
						<div class="right-content">
							...
							<a href="Advertisment.html" >More <i class="fa fa-arrow-circle-right"></i></a>
						</div>	
					</div>
			...
			<div class="col-lg-4 col-xs-12">
				<div class="box-content">
					<h4 class="box-title text-info">Registration</h4>
					<div class="content widget-stat">
						<div class="left-content margin-top-15">
							<i class="menu-icon mdi mdi-account-card-details"></i>
						</div>
						...
						<div class="right-content">
							<p class="text text-info">Making user Registration</p>
							<a href="Registration.php" >More <i class="fa fa-arrow-circle-right"></i></a>
						</div>
					</div>	
				</div>
			</div>
			...
			<div class="col-lg-4 col-xs-12">
				<div class="box-content">
					<h4 class="box-title text-info">List</h4>
					<div class="content widget-stat">
						...
						<div class="right-content">	
							<p class="text text-info">All Registered users</p>
							<a href="RegisteredList.php" >More <i class="fa fa-arrow-circle-right"></i></a>
						</div>
					</div>
				</div>	
			</div>
